...
PICS = (environ.get('PICS', 'https://i.ibb.co/GfSVJ6vr/x.jpg')).split()  # Sample pic
...
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1003770993867')  # Support group id (make sure bot is admin)
reqst_channel = environ.get('REQST_CHANNEL_ID', '-100')  # Request channel id (make sure bot is admin)
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/BZ_ZIXO')  # Support group link (make sure bot is admin)
...
auth_channels     = environ.get("AUTH_CHANNELS", "-1003581216470 -1003770993867")# Channels for force sub (make sure bot is admin)
...
# ============================
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://hishammon:hishammon@cluster0.2g7bqyf.mongodb.net/?appName=Cluster0")  # MongoDB URI for the database
...
# ============================
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/chitrashalamoviegroup') # Group link for the bot
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/BZ_ZIXO') # Owner link for the bot
UPDATE_CHNL_LNK = environ.get('UPDATE_CHNL_LNK', 'https://t.me/+adSv-UXODgAwNjZl') # Update channel link for the bot
