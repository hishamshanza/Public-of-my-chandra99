...
<blockquote>👇 നിങ്ങൾ പറഞ്ഞത് ഞങ്ങൾക്ക് കണ്ടെത്താനായില്ല താഴെപ്പറയുന്നവയിൽ ഏതെങ്കിലും ആണോ നിങ്ങൾ ഉദ്ദേശിച്ചത് ⭐</blockquote>"""
...
<blockquote expandable><b><i>ᴘʟᴇᴀꜱᴇ ꜰᴏʀᴡᴀʀᴅ ᴛʜɪꜱ ꜰɪʟᴇ ᴛᴏ ꜱᴏᴍᴇᴡʜᴇʀᴇ ᴇʟꜱᴇ & ꜱᴛᴀʀᴛ ᴅᴏᴡɴʟᴏᴀᴅɪɴɢ ᴛʜᴇʀᴇ</i></b></blockquote>"""
    ...
    I_CUDNT = """<b> നിങ്ങൾ തിരഞ്ഞത് തീരെ എനിക്ക് കണ്ടെത്താനായില്ല ⭐ {} 😕
...
<blockquote>😌 എങ്കിൽ നിങ്ങൾ പറഞ്ഞത് ശരിയാണ് പക്ഷേ എന്റെ ഡാറ്റ ബേസിൽ ഇല്ല ⭐</blockquote>"""
...
Mᴇꜱꜱᴀɢᴇ : <b>{}</b>"""
    ...
    CAPTION = """<b><a href="https://t.me/chitrashalamoviegroup">{file_name}</a></b>\n\n<b>⚜️ Powered By : <a href="https://t.me/chitrashalamoviegroup">[ CHITRASHALA MOVIE GROUP ✔️]</a></b>"""
